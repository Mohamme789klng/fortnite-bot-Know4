...
print(crayons.cyan(f'Discord server: https://discord.gg/qMSss4e - For support, questions, etc.'))
...
class SilverBot(commands.Bot):
    def __init__(self, email : str, password : str, **kwargs) -> None:
        ...
        self.default_skin = "CID_NPC_Athena_Commando_M_CatBurglar_Ghost"
        self.default_backpack = "BID_105_GhostPotal"
        self.default_pickaxe = "Pickaxe_Lockjaw"
        self.banner = "INFLUENCERBANNER57"
        self.banner_colour = "defaultcolor15"
        self.default_level = 874
        self.default_bp_tier = 874
        self.default_emote = "eid_JellyFrog"

        self.sanic_app = sanic_app
        self.server = server
        self.welcome_message = "السلام عليكم"
